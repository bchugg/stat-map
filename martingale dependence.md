...
Martingale dependence posits that there is a constant conditional mean: For data $X_1,\dots,X_n$ there exists some $\mu$ such that $\E[X_t | \calF_{t-1}]=\mu$ for all $t$ and some filtration $(\calF_t)$. This conditional often comes up in [[multi-armed bandits]] and [[contextual bandit]] problems. 
