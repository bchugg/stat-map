...
Let $K:\Re \to \Re$ be a 1-d _smoothing kernel_ (distinct from the Mercer kernels used in [[nonparametric density estimation]]) i.e., 
...
Kernel regression is a special case of [[local polynomial regression]]. 
