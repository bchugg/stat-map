...
Given samples $X_1,\dots,X_n\sim P$ we want to estimate the density of $P$. We can consider both [[parametric density estimation]] and [[nonparametric density estimation]], the former of course being easier but sensitive to model misspecification. 
